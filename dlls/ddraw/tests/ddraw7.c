...
static void test_coop_level_mode_set(void)
{
    ...
    /* Test that mode restoration uses display settings in the registry after RestoreDisplayMode() */
    ddraw = create_ddraw();
    ok(!!ddraw, "Failed to create a ddraw object.\n");
    hr = set_display_mode(ddraw, param.ddraw_width, param.ddraw_height);
    ok(hr == DD_OK, "Failed to set display mode, hr %#x.\n", hr);
...
static void test_coop_level_mode_set_multi(void)
{
    ...
    ok(lstrlenW(second_monitor_name), "Got empty second monitor name.\n");
    ...
    /* Test that no mode restorations for other monitors if SetDisplayMode() is not called */
    ddraw1 = create_ddraw();
    ok(!!ddraw1, "Failed to create a ddraw object.\n");
    hr = IDirectDraw7_SetCooperativeLevel(ddraw1, window, DDSCL_EXCLUSIVE | DDSCL_FULLSCREEN);
    ok(hr == DD_OK, "SetCooperativeLevel failed, hr %#x.\n", hr);
    ...
    /* Test that mode restoration happens for other monitors on ddraw releases if SetDisplayMode is
     * called */
    ddraw1 = create_ddraw();
    ok(!!ddraw1, "Failed to create a ddraw object.\n");
    hr = set_display_mode(ddraw1, 800, 600);
    ...
    /* Test that mode restoration happens for other monitors on device mode restores */
    ddraw1 = create_ddraw();
    ok(!!ddraw1, "Failed to create a ddraw object.\n");
    hr = set_display_mode(ddraw1, 800, 600);
    ok(hr == DD_OK, "Failed to set display mode, hr %#x.\n", hr);
    ...
    /* Test that mode restoration for other monitors use display settings in the registry */
    ddraw1 = create_ddraw();
    ok(!!ddraw1, "Failed to create a ddraw object.\n");
    hr = set_display_mode(ddraw1, 800, 600);
    ok(hr == DD_OK, "Failed to set display mode, hr %#x.\n", hr);
    ...
    /* Test mode restoration for other monitors when there are multiple fullscreen ddraw objects
     * and one of them restores display mode */
    ddraw1 = create_ddraw();
    ok(!!ddraw1, "Failed to create a ddraw object.\n");
    ddraw2 = create_ddraw();
