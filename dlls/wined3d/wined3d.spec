...
@ cdecl wined3d_adapter_get_identifier(ptr long long ptr)
@ cdecl wined3d_adapter_get_output(ptr long long)
...
@ cdecl wined3d_device_set_cursor_properties(ptr long long long ptr long)
