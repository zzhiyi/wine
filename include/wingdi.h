...
typedef enum {
    DISPLAYCONFIG_DEVICE_INFO_GET_SOURCE_DPI_SCALE           = (int)-3, /* Undocumented */
    DISPLAYCONFIG_DEVICE_INFO_SET_SOURCE_DPI_SCALE           = (int)-4, /* Undocumented */
...
/* DISPLAYCONFIG_GET_SOURCE_DPI_SCALE and DISPLAYCONFIG_SET_SOURCE_DPI_SCALE are undocumented.
 *
 * For example, scales : 100% 125% 150% 175% 200% 225% 250% 300% 350% 400% 450% 500%
...
typedef struct DISPLAYCONFIG_GET_SOURCE_DPI_SCALE
{
    ...
    int maxRelativeScaleStep;   /* Minimum scale step relative to the recommended scale */
