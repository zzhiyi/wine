...
#define WINED3DOUTPUT_DEFAULT                                   0
...
HRESULT __cdecl wined3d_adapter_check_device_format(const struct wined3d *wined3d, UINT adaper_idx,
...
struct wined3d_output * __cdecl wined3d_adapter_get_output(const struct wined3d *wined3d, UINT adapter_idx,
        UINT output_idx);
...
HRESULT __cdecl wined3d_output_get_desc(const struct wined3d *wined3d, unsigned int output_idx,
...
UINT __cdecl wined3d_output_get_mode_count(const struct wined3d *wined3d, UINT output_idx,
        enum wined3d_format_id format_id, enum wined3d_scanline_ordering scanline_ordering);
HRESULT __cdecl wined3d_output_get_raster_status(const struct wined3d *wined3d, UINT output_idx,
        struct wined3d_raster_status *raster_status);
void __cdecl wined3d_output_release_ownership(const struct wined3d_output *output);
HRESULT __cdecl wined3d_output_set_display_mode(struct wined3d *wined3d,
...
HRESULT __cdecl wined3d_swapchain_state_resize_target(struct wined3d_swapchain_state *state,
        struct wined3d *wined3d, unsigned int output_idx, const struct wined3d_display_mode *mode);
