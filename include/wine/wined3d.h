...
void __cdecl wined3d_hook_swapchain_state(struct wined3d_swapchain_state *state);
void __cdecl wined3d_unhook_swapchain_state(struct wined3d_swapchain_state *state);
